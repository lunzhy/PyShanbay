...
class UIMainWidget(QtGui.QWidget):
    ...
    def set_ui_text(self):
        ...
        self.label_read_member.setText("组员页数：3/7")
        self.label_get_username.setText("用户名：123/700")
        return None
    ...
    def setup_ui_stretch(self):
        ...
        self.label_get_username = QtGui.QLabel(self)
        self.label_get_username.setObjectName(_fromUtf8("label_get_username"))
        self.horizontalLayout_2.addWidget(self.label_get_username)
        spacerItem9 = QtGui.QSpacerItem(400, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
