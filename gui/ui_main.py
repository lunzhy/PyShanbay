...
class UIMainWidget(QtGui.QWidget):
    ...
    def set_ui_text(self):
        ...
        self.btn_show_leave.setText("显示请假")
        return None
    ...
    def setup_ui_stretch(self):
        ...
        self.btn_show_leave = QtGui.QPushButton(self)
        self.btn_show_leave.setCheckable(True)
        self.btn_show_leave.setObjectName(_fromUtf8("btn_show_leave"))
        self.horizontalLayout_6.addWidget(self.btn_show_leave)
