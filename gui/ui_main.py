...
class UIMainWidget(QtGui.QWidget):
    ...
    def setup_ui_stretch(self):
        ...
        self.label_get_diary.setObjectName(_fromUtf8("label_get_username"))
        ...
        self.edit_absent_days.setObjectName(_fromUtf8("edit_uncheckin_days"))
        ...
        self.btn_absent_days.setObjectName(_fromUtf8("btn_uncheckin_days"))
        ...
        self.tb_group.setColumnCount(0)
        self.tb_group.setRowCount(0)
        self.gridLayout_4.addWidget(self.tb_group, 8, 0, 1, 1)
        ...
        self.tb_recent_words.setMinimumSize(QtCore.QSize(0, 80))
